      ...
      <div className="container mx-auto px-4 z-10 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Professional cybersecurity services for cloud infrastructure, IT
            audits, and comprehensive security operations. Protect your business
            from evolving threats with our expert team.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 pt-8 border-t border-border">
            <div className="text-center">
              <div className="text-3xl font-bold text-primary mb-2">Worldwide</div>
